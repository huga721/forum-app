...
class ReportControllerTest extends ContainerIT {
    ...
    private static final String CREATE_TOPIC_REPORT_ENDPOINT = "/api/v1/reports/topic/1";
    private static final String CREATE_TOPIC_REPORT_TOPIC_IS_CLOSED_ENDPOINT = "/api/v1/reports/topic/8";
    private static final String CREATE_TOPIC_REPORT_DOESNT_EXIST_ENDPOINT = "/api/v1/reports/topic/999";
    private static final String CREATE_COMMENT_REPORT_ENDPOINT = "/api/v1/reports/comment/1";
    private static final String CREATE_COMMENT_REPORT_TOPIC_IS_CLOSED_ENDPOINT = "/api/v1/reports/comment/5";
    private static final String CREATE_COMMENT_REPORT_DOESNT_EXIST_ENDPOINT = "/api/v1/reports/comment/999";
    private static final String GET_ALL_REPORTS_ENDPOINT = "/api/v1/reports";
    private static final String GET_REPORT_BY_ID_ENDPOINT = "/api/v1/reports/1";
    private static final String GET_REPORT_BY_ID_DOESNT_EXIST_ENDPOINT = "/api/v1/reports/999";
    private static final String GET_ALL_NOT_SEEN_REPORTS_ENDPOINT = "/api/v1/reports/not-seen";
    private static final String MARK_REPORT_AS_SEEN_ENDPOINT = "/api/v1/reports/mark-as-seen/4";
    private static final String MARK_REPORT_AS_SEEN_DOESNT_EXIST_ENDPOINT = "/api/v1/reports/mark-as-seen/999";
    private static final String EXECUTE_REPORTS_OF_TOPIC_ENDPOINT = "/api/v1/reports/execute/topic/14";
    private static final String EXECUTE_REPORTS_OF_TOPIC_DOESNT_EXIST_ENDPOINT = "/api/v1/reports/execute/topic/999";
    private static final String EXECUTE_REPORTS_OF_TOPIC_TOPIC_IS_CLOSED_ENDPOINT = "/api/v1/reports/execute/topic/8";
    private static final String EXECUTE_REPORTS_OF_TOPIC_NOT_ENOUGH_REPORTS_ENDPOINT = "/api/v1/reports/execute/topic/1";
    private static final String EXECUTE_REPORTS_OF_COMMENT_ENDPOINT = "/api/v1/reports/execute/comment/8";
    private static final String EXECUTE_REPORTS_OF_COMMENT_DOESNT_EXIST_ENDPOINT = "/api/v1/reports/execute/comment/999";
    private static final String EXECUTE_REPORTS_OF_COMMENT_TOPIC_IS_CLOSED_ENDPOINT = "/api/v1/reports/execute/comment/5";
    private static final String EXECUTE_REPORTS_OF_COMMENT_NOT_ENOUGH_REPORTS_ENDPOINT = "/api/v1/reports/execute/comment/1";
    private static final String DELETE_REPORT_ENDPOINT = "/api/v1/reports/delete/15";
    private static final String DELETE_REPORT_DOESNT_EXIST_ENDPOINT = "/api/v1/reports/delete/999";
