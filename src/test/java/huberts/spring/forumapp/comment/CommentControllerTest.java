...
class CommentControllerTest extends ContainerIT {
    ...
    private static final String ALL_COMMENTS_ENDPOINT = "/comments";
    private static final String GET_COMMENT_BY_ID_ENDPOINT = "/comments/1";
    private static final String GET_COMMENT_BY_ID_DOESNT_EXIST_ENDPOINT = "/comments/999";
    private static final String GET_COMMENTS_BY_TOPIC_ID_ENDPOINT = "/comments/topic/1";
    private static final String GET_COMMENTS_BY_TOPIC_ID_DOESNT_EXIST_ENDPOINT = "/comments/topic/999";
    private static final String GET_COMMENTS_BY_USER_ENDPOINT = "/comments/user/userJwt";
    private static final String GET_COMMENTS_BY_USER_WRONG_USERNAME_ENDPOINT = "/comments/user/fakeUser";
    private static final String GET_COMMENTS_OF_AUTHENTICATED_USER_ENDPOINT = "/comments/user";
    private static final String CREATE_COMMENT_ENDPOINT = "/comments/topic/2";
    private static final String CREATE_COMMENT_TOPIC_DOESNT_EXIST_ENDPOINT = "/comments/topic/999";
    private static final String CREATE_COMMENT_TOPIC_IS_CLOSED_ENDPOINT = "/comments/topic/8";
    private static final String DELETE_COMMENT_BY_AUTHOR_ENDPOINT = "/comments/delete/3";
    private static final String DELETE_COMMENT_BY_AUTHOR_TOPIC_IS_CLOSED_ENDPOINT = "/comments/delete/5";
    private static final String DELETE_COMMENT_BY_AUTHOR_USER_IS_NOT_AUTHOR_ENDPOINT = "/comments/delete/2";
    private static final String DELETE_COMMENT_BY_AUTHOR_DOESNT_EXIST_ENDPOINT = "/comments/delete/999";
    private static final String EDIT_COMMENT_BY_AUTHOR_ENDPOINT = "/comments/edit/4";
    private static final String EDIT_COMMENT_BY_AUTHOR_DOESNT_EXIST_ENDPOINT = "/comments/edit/999";
    private static final String EDIT_COMMENT_BY_AUTHOR_TOPIC_IS_CLOSED_ENDPOINT = "/comments/edit/5";
    private static final String DELETE_COMMENT_BY_MODERATOR_ENDPOINT = "/comments/moderator/delete/6";
    private static final String DELETE_COMMENT_BY_MODERATOR_DOESNT_EXIST_ENDPOINT = "/comments/moderator/delete/999";
    private static final String DELETE_COMMENT_BY_MODERATOR_TOPIC_IS_CLOSED_ENDPOINT = "/comments/moderator/delete/5";
    private static final String EDIT_COMMENT_BY_MODERATOR_ENDPOINT = "/comments/moderator/edit/7";
    private static final String EDIT_COMMENT_BY_MODERATOR_DOESNT_EXIST_ENDPOINT = "/comments/moderator/edit/999";
    private static final String EDIT_COMMENT_BY_MODERATOR_TOPIC_IS_CLOSED_ENDPOINT = "/comments/moderator/edit/5";
