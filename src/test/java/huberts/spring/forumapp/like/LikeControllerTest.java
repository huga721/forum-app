...
class LikeControllerTest extends ContainerIT {
    ...
    private static final String GET_ALL_LIKES_ENDPOINT = "/likes";
    private static final String GET_LIKE_BY_ID_ENDPOINT = "/likes/1";
    private static final String GET_LIKE_BY_ID_DOESNT_EXIST_ENDPOINT = "/likes/999";
    private static final String GET_LIKES_BY_USER_ENDPOINT = "/likes/user";
    private static final String CREATE_TOPIC_LIKE_ENDPOINT = "/likes/topic/2";
    private static final String CREATE_TOPIC_LIKE_DOESNT_EXIST_ENDPOINT = "/likes/topic/999";
    private static final String CREATE_TOPIC_LIKE_TOPIC_IS_CLOSED_ENDPOINT = "/likes/topic/8";
    private static final String CREATE_TOPIC_LIKE_EXISTS_ENDPOINT = "/likes/topic/1";
    private static final String CREATE_COMMENT_LIKE_ENDPOINT = "/likes/comment/2";
    private static final String CREATE_COMMENT_LIKE_DOESNT_EXIST_ENDPOINT = "/likes/comment/999";
    private static final String CREATE_COMMENT_LIKE_TOPIC_IS_CLOSED_ENDPOINT = "/likes/comment/5";
    private static final String CREATE_COMMENT_LIKE_EXISTS_ENDPOINT = "/likes/comment/1";
    private static final String DELETE_LIKE_BY_AUTHOR_ENDPOINT = "/likes/delete/3";
    private static final String DELETE_LIKE_BY_AUTHOR_USER_IS_NOT_AUTHOR_ENDPOINT = "/likes/delete/4";
    private static final String DELETE_LIKE_BY_AUTHOR_DOESNT_EXIST_ENDPOINT = "/likes/delete/999";
    private static final String DELETE_LIKE_BY_AUTHOR_TOPIC_IS_CLOSED_ENDPOINT = "/likes/delete/5";
    private static final String DELETE_LIKE_BY_MODERATOR_ENDPOINT = "/likes/moderator/delete/6";
    private static final String DELETE_LIKE_BY_MODERATOR_DOESNT_EXIST_ENDPOINT = "/likes/moderator/delete/999";
    private static final String DELETE_LIKE_BY_MODERATOR_TOPIC_IS_CLOSED_ENDPOINT = "/likes/moderator/delete/5";
